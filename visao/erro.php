...
<html>
	...
	<body>
		...
		<section id="conteudo" style="margin-bottom: 0; border-bottom:0;">
		    <div class="principal">
	            <h1 class="titulos" style="margin-top:0; margin:0 auto;">You died</h1>
	            <h2 class="subtitulos">Dados invalidos</h2>
	            <a class="titulos" href="../visao/contato.html">Voltar ao cadastro</a>
	       </div>
	   </section>
